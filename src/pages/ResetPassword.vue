<script lang="ts" setup>
 ...
 function resetPassword(){
    if(new_password.value === ""){
        useAlertModalComposable("Please ensue that a new password is enterd.")
    }else{
...
<template>
    <motion.section
     class="flex justify-center items-center h-full w-full p-1.5"
    ...
    >
        <motion.div
         ...
         :'bg-white'"
        >
            <img class="h-96" src="/resetPassword.png" alt="reset-password">
            ...
            >
                ...
                <div class="flex w-full flex-col space-y-1">
                    <label for="_reset_link">New Password</label>
                    <input
