            ...
            >
             <div class="flex space-x-1 w-full justify-start items-center lg:text-2xl text-lg font-medium p-1.5">
                ...
                <p 
                 ...
                 :'bg-white'"
                >
                  The Settings page provides options to view user profile and reset password.
                </p>
            </motion.div>
            ...
            >
              ...
              <AnimatePresence>
                ...
                <motion.div
                  ...
                  :exit="{y:-100, opacity:0}"
                  class="w-full h-full flex p-1 rounded-2xl border"
                  :class="useThemeComposable() ? 'border-teal-950 bg-Dark'
                  :'border-teal-200 bg-white'"
                >
                  <motion.div
                    class="p-4 flex flex-col space-y-4 w-full h-full rounded-2xl justify-center items-center"
                    :class="useThemeComposable() ? 'bg-innerDark'
                    :'bg-off_white'"
                  >
                    <motion.svg 
                     ...
                     fill="currentColor" 
                     class="size-32"
                     :class="useThemeComposable() ? 'text-white'
                     :' text-green-500'"
                     :initial="{ opacity:0.6}"
