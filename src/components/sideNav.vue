...
<template>
   ...
   >    
      <div 
       class="flex flex-col space-y-1 xl:p-1.5 lg:p-0.5 rounded-2xl w-full border"
      ...
      >
        ...
        <motion.div
             ...
             :exit="staggered_animation(0.6,2,0,-10).exit"
              class="flex flex-col w-full space-y-2 xl:px-4 xl:py-2 lg:px-2 lg:py-1 justify-center items-center rounded-md"
            ...
            >
              ...
              <h2 class="font-medium lg:text-[10px]">{{ userInfo.email_address }}</h2>
        </motion.div>
        ...
        <motion.div
             ...
             class="flex py-1 lg:px-1 p-4 justify-between items-center w-full rounded-md"
             :class="useThemeComposable() ? 'bg-Dark'
             :'bg-white'"
            >
              <motion.button
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="lg:size-4 xl:size-6">
      ...
      >
        ...
        >
          <svg  
            v-if="nav.name === 'Home'"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="xl:size-6 lg:size-4">
            <path d="M14.916 2.404a.75.75 0 0 1-.32 1.011l-.596.31V17a1 1 0 0 1-1 1h-2.26a.75.75 0 0 1-.75-.75v-3.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.5a.75.75 0 0 1-.75.75h-3.5a.75.75 0 0 1 0-1.5H2V9.957a.75.75 0 0 1-.596-1.372L2 8.275V5.75a.75.75 0 0 1 1.5 0v1.745l10.404-5.41a.75.75 0 0 1 1.012.319ZM15.861 8.57a.75.75 0 0 1 .736-.025l1.999 1.04A.75.75 0 0 1 18 10.957V16.5h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1-.75-.75V9.21a.75.75 0 0 1 .361-.64Z" />
          </svg>

          <svg 
           v-if="nav.name === 'Exhibitor'"
           xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="xl:size-6 lg:size-4"
          >
      ...
      <div 
        class="w-full p-2.5 flex flex-col space-y-1 justify-center items-center rounded-2xl rounded-t-md"
        :class="useThemeComposable() ? 'bg-innerDark/85 border-teal-950 text-white'
        :'bg-off_white'"
      >
        <p class="text-center font-semibold lg:text-xs text-xs">
